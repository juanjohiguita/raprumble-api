...
import {getVote, getVotes, createVote, deleteVote, updateVoteScoreMC1} from '../controllers/votes.controller.js'; // Importar con llaves significa que se importa una función específica, mientras que sin llaves se importa todo el archivo
...
// router.put("/votes/:id", updateVoteScoreMC1
//);
